package videostatus.setcallertunewallpaper.quotestatus.saved.adapter;
...
import videostatus.setcallertunewallpaper.quotestatus.saved.ui.QuotesViewSavedActivity;
...
public class QuotesSavedAdapter extends RecyclerView.Adapter<QuotesSavedAdapter.MyViewHolder> {
    int activity_type;
    ...
    public QuotesSavedAdapter(Activity context, ArrayList<FileModel> filePathStrings) {
        this.context = context;
        this.fileModelArrayList = filePathStrings;
    }

    public QuotesSavedAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        List<QuotesSavedAdapter.MyViewHolder> holders = new ArrayList();
        return new QuotesSavedAdapter.MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_row_for_image, parent, false));
    }

    @SuppressLint("LongLogTag")
    @Override
    public void onBindViewHolder(final QuotesSavedAdapter.MyViewHolder holder, final int position) {
            ...
            holder.img.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    if(remainder == 0) {
                        ...
                        intentMain = new Intent(context, QuotesViewSavedActivity.class);
                        ...
                        Intent i = new Intent(context, QuotesViewSavedActivity.class);
