...
import videostatus.setcallertunewallpaper.quotestatus.saved.adapter.QuotesSavedImageAdapter;
import videostatus.setcallertunewallpaper.quotestatus.saved.model.FileModel;

import java.io.File;
import java.io.IOException;

public class QuotesViewSavedActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quotes_view_saved);
        ...
        if (extras != null) {
          ...
          /*  Picasso.with(ImaegeTutorialActivity.this)
            ...
            QuotesSavedImageAdapter adapter = new QuotesSavedImageAdapter(this);
    ...
    private void DeleteActivity() {
        ...
        fileModel = (FileModel) QuotesSavedAdapter.fileModelArrayList.get(position);
        ...
        if (fdelete.exists()) {
            if (fdelete.delete()) {
                ...
                QuotesSavedAdapter.fileModelArrayList.remove(position);
