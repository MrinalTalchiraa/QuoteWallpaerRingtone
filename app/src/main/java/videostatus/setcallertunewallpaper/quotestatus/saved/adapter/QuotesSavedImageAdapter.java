...
public class QuotesSavedImageAdapter extends PagerAdapter {
    Context context;
    LayoutInflater mLayoutInflater;
    private ArrayList<FileModel> ImagesList = QuotesSavedListActivity.FilePathStrings;

    public QuotesSavedImageAdapter(Context context) {
