...
public class AppHomePageMainActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_app_home_main);
        ...
        ((LinearLayout) findViewById(R.id.btnstart)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(AppHomePageMainActivity.this, FirstPageMainActivity.class);
                SplashLaunchActivity.InterstitialAdsCall(AppHomePageMainActivity.this, intent);
            }
        });
    ...
    public void onBackPressed() {
        ...
        final Dialog dialog = new Dialog(AppHomePageMainActivity.this, R.style.DialogTheme);
        ...
        Animation animation1 = AnimationUtils.loadAnimation(AppHomePageMainActivity.this,
                R.anim.slide_up);
        ...
        Yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(AppHomePageMainActivity.this, AppExitActivity.class);
                SplashLaunchActivity.InterstitialAdsCall(AppHomePageMainActivity.this, intent);
            }
        });
    ...
    private void PrivacyDialog() {
        ...
        final Dialog dialog = new Dialog(AppHomePageMainActivity.this);
