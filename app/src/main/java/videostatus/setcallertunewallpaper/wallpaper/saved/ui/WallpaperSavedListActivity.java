...
public class WallpaperSavedListActivity extends AppCompatActivity {

    WallpaperSavedAdapter wallpaperSavedAdapter;
    String fileNames;
    String filepath;
    ...
    File imageRoot = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + File.separator + "Quotes Status Ringtone/Wallpaper");
    ...
    public void fetchImageLocationAndName() {
        ...
        this.wallpaperSavedAdapter = new WallpaperSavedAdapter(this, FilePathStrings);
