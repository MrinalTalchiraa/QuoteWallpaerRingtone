...
public class WallpaperViewActivity extends AppCompatActivity {
    ...
    public static List<WallpaperData> mlist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleText.setText(WallpaperCategoryListActivity.Catename);
        ...
        try {
            ...
            mlist = (ArrayList<WallpaperData>) bundle.getSerializable("arraylist");
        ...
        name = WallpaperCategoryListActivity.Catename;
        ...
        Download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Toast.makeText(WallpaperViewActivity.this, link11, Toast.LENGTH_LONG).show();

                DownloadLink = link11;
                action = 0;

                if (isCheckDownload == false) {
                    new DownloadTask(WallpaperViewActivity.this).execute(new String[]{link11});
                } else {
                    Toast.makeText(WallpaperViewActivity.this, "Image Already Downloaded", Toast.LENGTH_SHORT).show();
                }
        ...
        WhatsApp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isCheckDownload == false) {
                    new DownloadTask(WallpaperViewActivity.this).execute(new String[]{link22});
                } else {
        ...
        Share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isCheckDownload == false) {
                    new DownloadTask(WallpaperViewActivity.this).execute(new String[]{link33});
                } else {
    ...
    public class ImagePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            Context context = WallpaperViewActivity.this;
    ...
    public class DownloadTask extends AsyncTask<String, String, String> {
        ...
        public void onPreExecute() {
            ...
            SplashLaunchActivity.MixNativeAdsCall(WallpaperViewActivity.this, shimmerFrameLayout, frameLayout, image, qurekanative, NativeAdContainer, NativeAdsStartApp, nativeMoPub, maxNative);
        ...
        public String doInBackground(String... args) {
            ...
            sb2.append(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + File.separator + "Quotes Status Ringtone/Wallpaper");
